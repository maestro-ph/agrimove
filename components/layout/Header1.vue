  ...
  <!-- <header  :class="{ 'sticky': scroll }">
    ...
    <header class="main-header header-style-one" :class="{ 'moblie-search-active': isSearch }">
      <div class="header-top">
        <div class="top-left">
          <div class="text"><i class="fa fa-map-marker color2 me-2"></i>80 Broklyn Golden Street, New York. USA</div>
      ...
      <div class="header-upper">
        <!-- Main box -->
        <div class="main-box">
          <div class="logo"><NuxtLink to="/"><img src="/images/logo1.png" alt="" title="logixs"></NuxtLink></div>
          ...
          <div class="nav-outer">
            ...
            <div class="outer-box">
              ...
              <NuxtLink to="#" class="theme-btn btn-style-one info-btn"><span class="btn-title"><i class="icon lnr-icon-phone-handset"></i><small>Call Anytime</small><br> +92 (8800) 9806</span></NuxtLink>
