        ...
        <div class="row">
          ...
          <div class="footer-column col-xl-4 col-lg-12 col-md-6 col-sm-12">
            <div class="footer-widget about-widget">
              <div class="logo"><NuxtLink to="index"><img src="/images/AgriMove Text White.png" alt="" /></NuxtLink></div>
              <div class="text">A logistics platform connecting farmers with specialized transport for produce, livestock, and equipment. With real-time tracking and seamless booking, it optimizes agricultural supply chains for efficiency and reliability.</div>
              ...
              <div class="subscribe-form">
                <form method="post" action="#">
                  <div class="form-group">
                    ...
                    required="">
                    <button type="button" class="theme-btn btn-style-one"><span class="btn-title">GO</span></button>
                  </div>
                </form>
              </div>
              ...
              <ul class="social-icon-one">
                ...
                <li><NuxtLink to="#"><i class="fab fa-pinterest-p"></i></NuxtLink></li>
          ...
          <div class="footer-column col-xl-3 col-lg-5 col-md-6 col-sm-12">
            <div class="footer-widget recent-posts">
              ...
              <div class="widget-content">
                <div class="post">
                  <div class="thumb"><NuxtLink to="#"><img src="/images/resource/post-thumb-1.jpg" alt=""></NuxtLink>
                  </div>
                  <span class="date">20 Jul, 2022</span>
                  <h4><NuxtLink to="#">Logixs name a finalist consumer choice award</NuxtLink></h4>
                </div>

                <div class="post">
                  <div class="thumb"><NuxtLink to="#"><img src="/images/resource/post-thumb-2.jpg" alt=""></NuxtLink>
                  </div>
                  <span class="date">20 Jul, 2022</span>
                  <h4><NuxtLink to="#">Logixs name a finalist consumer choice award</NuxtLink></h4>
                </div>
      ...
      <div class="auto-container">
        <div class="inner-container">
          <div class="copyright-text">
            <p>© Copyright received by <NuxtLink to="index">kodesolution</NuxtLink></p>
          </div>
        </div>
      </div>
    </div>
