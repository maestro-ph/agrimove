			...
			<div class="row">
				<div class="col-xl-12">
					<div class="project-details__top">
						<div class="project-details__img"> <img src="/images/resource/service-details.jpg" alt=""> </div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xl-8 col-lg-8">
						<div class="project-details__content-left">
							...
							<h3 class="">Reason For Choosing Us</h3>
							...
							<h3 class="">Logistic Solution for Your Business</h3>
